        ...
        <div className="h-screen">
            ...
            <section id="Service" className="mt-36 lg:mt-96 xl:mt-48">
                <div className="text-center">
                    <p className="text-xl font-bold text-[#373A40]">HOW IT WORKS</p>
                ...
                <div className="relative container m-10 mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                        ...
                        {/* <div className="bg-white shadow-lg px-16 py-5 rounded-xl text-center mt-5 z-10">
                            <p className="font-bold text-sky-500">Branches</p>
                            <img src="/images/branch.png" alt="" className="h-24"/>
                            <p className="font-black text-5xl text-yellow-500">8</p>
                        </div>
                        <div className="bg-white shadow-lg px-16 py-5 rounded-xl text-center z-10">
                            <p className="font-bold text-sky-500">Jobs Done</p>
                            <img src="/images/jobs.png" alt="" className="h-24"/>
                            <p className="font-black text-5xl text-blue-500">203</p>
                        </div>
                        <div className="bg-white shadow-lg px-16 py-5 rounded-xl text-center z-10">
                            <p className="font-bold text-sky-500">Jobs Done</p>
                            <img src="/images/jobs.png" alt="" className="h-24"/>
