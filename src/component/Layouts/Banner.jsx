...
const Banner = () => {
    ...
    return (
        <section id="Home" className={`banner relative ${isDarkMode && "banner-dark"}`}>
            <div className="px-12 flex flex-row items-center pt-32 h-3/4">
                <div className="">
                    <p className={`text-md sm:text-lg md:text-2xl lg:text-3xl xl:text-4xl font-bold tracking-[0.2rem] ${isDarkMode ? "text-white" : "text-[#373A40]"}`}>Let us handle your <br /> dry cleaning & <span className="text-yellow-400">laundry</span></p>
